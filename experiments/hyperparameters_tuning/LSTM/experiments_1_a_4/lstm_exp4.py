...
if __name__ == '__main__':
		exp = ExperimentProcesses('lstm_exp4')
		
		exp.pp_data.vocabulary_size = 5000
		exp.pp_data.embedding_size = 300
		exp.pp_data.max_posts = None
		exp.pp_data.max_terms_by_post = None
		...
		lstm.model.add(LSTM(64, activation='relu', dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
		lstm.model.add(LSTM(64, activation='relu', dropout=0.2, recurrent_dropout=0.2))
