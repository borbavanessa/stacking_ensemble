...
if __name__ == '__main__':
		exp = ExperimentProcesses('lstm_exp5')
		
		exp.pp_data.vocabulary_size = 5000
		exp.pp_data.embedding_size = 300
		exp.pp_data.max_posts = 968
		exp.pp_data.max_terms_by_post = 148
		...
		lstm.model.add(LSTM(64, activation='tanh', dropout=0.2, recurrent_dropout=0.2, return_sequences=False))
