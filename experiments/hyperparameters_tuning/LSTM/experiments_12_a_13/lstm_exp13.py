...
if __name__ == '__main__':
		...
		lstm_layer.add(LSTM(64, activation='tanh', dropout=0.2, recurrent_dropout=0.2, return_sequences=True,
												input_shape=(exp.pp_data.vocabulary_size, exp.pp_data.embedding_size)))
		lstm_layer.add(LSTM(64, activation='tanh', dropout=0.2, recurrent_dropout=0.2))
